...
public class BetterDynamicAnimation {
   ...
   public void update() {
      ...
      this.step = MathHelper.method_15340(this.step + 1, 0, this.maxTicks);
   }
   ...
   public double getAnimationD() {
      ...
      double animation = createAnimation((double)((float)this.prevStep + (float)(this.step - this.prevStep) * Wrapper.mc.method_1488()) / (double)this.maxTicks);
