...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    public void onUpdate() {
        ...
        for (PlayerEntity player : CombatUtil.getEnemies(this.range.getValue())) {
            ...
            for (Direction i : Direction.values()) {
                BlockPos pos2;
                if (i == Direction.field_11036 || i == Direction.field_11033 || !this.isTargetHere(pos2 = EntityUtil.getEntityPos((Entity)player).method_10093(i), (Entity)player) || !HolePush.mc.field_1687.method_39454((Entity)player, new Box(pos2))) continue;
                if (this.tryPush(EntityUtil.getEntityPos((Entity)player).method_10093(i.method_10153()), i)) {
                    this.timer.reset();
                    return;
                }
                if (!this.tryPush(EntityUtil.getEntityPos((Entity)player).method_10093(i.method_10153()).method_10084(), i)) continue;
                this.timer.reset();
                return;
            }
            for (float x : offset = new float[]{-0.25f, 0.0f, 0.25f}) {
                for (float z : offset) {
                    ...
                    for (Direction i : Direction.values()) {
                        if (i == Direction.field_11036 || i == Direction.field_11033 || !this.isTargetHere(pos = playerPos.method_10093(i), (Entity)player) || !HolePush.mc.field_1687.method_39454((Entity)player, new Box(pos))) continue;
            ...
            if (!HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317(), player.method_23318() + 2.5, player.method_23321())))) {
                for (Direction i : Direction.values()) {
                    if (i == Direction.field_11036 || i == Direction.field_11033) continue;
                    BlockPos pos3 = EntityUtil.getEntityPos((Entity)player).method_10093(i);
                    Box box = player.method_5829().method_997(new Vec3d((double)i.method_10148(), (double)i.method_10164(), (double)i.method_10165()));
                    if (this.getBlock(pos3.method_10084()) == Blocks.field_10379 || HolePush.mc.field_1687.method_39454((Entity)player, box.method_989(0.0, 1.0, 0.0)) || this.isTargetHere(pos3, (Entity)player)) continue;
                    if (this.tryPush(EntityUtil.getEntityPos((Entity)player).method_10093(i.method_10153()).method_10084(), i)) {
                        this.timer.reset();
                        return;
                    }
                    if (!this.tryPush(EntityUtil.getEntityPos((Entity)player).method_10093(i.method_10153()), i)) continue;
                    this.timer.reset();
                    return;
                }
            }
            for (float x : offset) {
                for (float z : offset) {
                    playerPos = new BlockPosX(player.method_23317() + (double)x, player.method_23318() + 0.5, player.method_23321() + (double)z);
                    for (Direction i : Direction.values()) {
                        if (i == Direction.field_11036 || i == Direction.field_11033 || !this.isTargetHere(pos = playerPos.method_10093(i), (Entity)player)) continue;
    ...
    private boolean tryPush(BlockPos piston, Direction direction) {
        ...
        if (this.isTrueFacing(piston, direction) && this.facingCheck(piston) && BlockUtil.clientCanPlace(piston)) {
            ...
            if (BlockUtil.getPlaceSide(piston, this.placeRange.getValue()) != null) {
                ...
                for (Direction direction2 : Direction.values()) {
                    if (this.getBlock(piston.method_10093(direction2)) != this.getBlockType()) continue;
                    canPower = true;
                    break;
                }
                ...
                for (int i = 0; i < n; ++i) {
                    ...
                    if (canPower) break;
                    if (!BlockUtil.canPlace(piston.method_10093(direction3), this.placeRange.getValue())) continue;
                    canPower = true;
                }
                ...
                if (canPower) {
                    ...
                    if (side != null) {
                        Vec3d directionVec;
                        if (this.rotate.getValue() && !this.faceVector(directionVec = new Vec3d((double)piston.method_10263() + 0.5 + (double)side.method_10163().method_10263() * 0.5, (double)piston.method_10264() + 0.5 + (double)side.method_10163().method_10264() * 0.5, (double)piston.method_10260() + 0.5 + (double)side.method_10163().method_10260() * 0.5))) {
                            return true;
                        }
                        if (this.yawDeceive.getValue()) {
                            HolePush.pistonFacing(direction.method_10153());
                        }
                        int old = HolePush.mc.field_1724.method_31548().field_7545;
                        ...
                        for (Direction i : Direction.values()) {
                            if (i == Direction.field_11036 && this.torch.getValue() || !BlockUtil.canPlace(piston.method_10093(i), this.placeRange.getValue())) continue;
                ...
                while (var7_23 < old) {
                    ...
                    if (i != Direction.field_11036 || !this.torch.getValue()) {
                ...
                if (powerFacing != null) {
                    ...
                    if (side2 != null) {
                        Vec3d directionVec;
                        if (this.rotate.getValue() && !this.faceVector(directionVec = new Vec3d((double)piston.method_10263() + 0.5 + (double)side2.method_10163().method_10263() * 0.5, (double)piston.method_10264() + 0.5 + (double)side2.method_10163().method_10264() * 0.5, (double)piston.method_10260() + 0.5 + (double)side2.method_10163().method_10260() * 0.5))) {
                            return true;
                        }
                        if (this.yawDeceive.getValue()) {
                            HolePush.pistonFacing(direction.method_10153());
                        ...
                        if (this.rotate.getValue() && this.yawDeceive.getValue()) {
                            EntityUtil.facePosSide(piston.method_10093(side2), side2.method_10153());
                        }
                    }
                    CombatUtil.modifyPos = null;
                    return true;
        ...
        if ((state = HolePush.mc.field_1687.method_8320(piston)).method_26204() instanceof PistonBlock && this.getBlockState(piston).method_11654((Property)FacingBlock.field_10927) == direction) {
            for (Direction direction4 : Direction.values()) {
                if (this.getBlock(piston.method_10093(direction4)) != this.getBlockType()) continue;
                if (this.autoDisable.getValue()) {
                    this.disable();
                    return true;
                }
            ...
            for (Direction direction5 : Direction.values()) {
                if (direction5 == Direction.field_11036 && this.torch.getValue() || !BlockUtil.canPlace(piston.method_10093(direction5), this.placeRange.getValue())) continue;
                int oldSlot = HolePush.mc.field_1724.method_31548().field_7545;
                int powerSlot = this.findBlock(this.getBlockType());
                this.doSwap(powerSlot);
    ...
    private boolean burrowUpdate(PlayerEntity player) {
        for (float x : new float[]{0.0f, 0.3f, -0.3f}) {
            for (float z : new float[]{0.0f, 0.3f, -0.3f}) {
                ...
                if (!new Box((BlockPos)pos).method_994(player.method_5829()) || HolePush.mc.field_1687.method_8320((BlockPos)pos).method_26204() != Blocks.field_10540 && HolePush.mc.field_1687.method_8320((BlockPos)pos).method_26204() != Blocks.field_23152 && HolePush.mc.field_1687.method_8320((BlockPos)pos).method_26204() != Blocks.field_9987 && HolePush.mc.field_1687.method_8320((BlockPos)pos).method_26204() != Blocks.field_10443) continue;
                return true;
            }
        }
        return false;
    ...
    private Boolean canPush(PlayerEntity player) {
        ...
        int progress = 0;
        if (HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317() + 1.0, player.method_23318() + 0.5, player.method_23321())))) {
            ++progress;
        }
        if (HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317() - 1.0, player.method_23318() + 0.5, player.method_23321())))) {
            ++progress;
        }
        if (HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317(), player.method_23318() + 0.5, player.method_23321() + 1.0)))) {
            ++progress;
        }
        if (HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317(), player.method_23318() + 0.5, player.method_23321() - 1.0)))) {
            ++progress;
        ...
        for (float x : offset) {
            for (float z : offset) {
                ...
                for (Direction i : Direction.values()) {
                    BlockPos pos;
                    if (i == Direction.field_11036 || i == Direction.field_11033 || !this.isTargetHere(pos = playerPos.method_10093(i), (Entity)player)) continue;
                    if (HolePush.mc.field_1687.method_39454((Entity)player, new Box(pos))) {
                        return true;
                    }
        ...
        if (!HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317(), player.method_23318() + 2.5, player.method_23321())))) {
            for (Direction i : Direction.values()) {
                ...
                Box box = player.method_5829().method_997(new Vec3d((double)i.method_10148(), (double)i.method_10164(), (double)i.method_10165()));
                if (this.getBlock(pos.method_10084()) == Blocks.field_10379 || HolePush.mc.field_1687.method_39454((Entity)player, box.method_989(0.0, 1.0, 0.0)) || this.isTargetHere(pos, (Entity)player) || !HolePush.mc.field_1687.method_39454((Entity)player, new Box((BlockPos)new BlockPosX(player.method_23317(), player.method_23318() + 0.5, player.method_23321())))) continue;
                return true;
            }
        }
    ...
    private Block getBlockType() {
        if (this.torch.getValue()) {
            return Blocks.field_10523;
        }
        return Blocks.field_10002;
    }
    ...
    private static final class _yzHmKDmPzgLjnTXAWdrq
    extends Enum<_yzHmKDmPzgLjnTXAWdrq> {
        public static final /* enum */ _yzHmKDmPzgLjnTXAWdrq General;
        public static final /* enum */ _yzHmKDmPzgLjnTXAWdrq Rotate;
        public static final /* enum */ _yzHmKDmPzgLjnTXAWdrq Check;

        public static _yzHmKDmPzgLjnTXAWdrq[] values() {
            return null;
        }

        public static _yzHmKDmPzgLjnTXAWdrq valueOf(String string) {
            return null;
        }
    }
}
