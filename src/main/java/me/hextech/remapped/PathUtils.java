...
public class PathUtils implements Wrapper {
   private static boolean canPassThrough(BlockPos pos) {
      Block block = mc.field_1687.method_8320(new BlockPos(pos.method_10263(), pos.method_10264(), pos.method_10260())).method_26204();
      return block == Blocks.field_10124
         || block instanceof PlantBlock
         || block == Blocks.field_10597
         || block == Blocks.field_9983
         || block == Blocks.field_10382
         || block == Blocks.field_27097
         || block instanceof WallSignBlock;
   }

   public static ArrayList<Vec3> computePath(LivingEntity fromEntity, LivingEntity toEntity) {
      return computePath(
         new Vec3(fromEntity.method_23317(), fromEntity.method_23318(), fromEntity.method_23321()),
         new Vec3(toEntity.method_23317(), toEntity.method_23318(), toEntity.method_23321())
      );
   }

   public static ArrayList<Vec3> computePath(Vec3d vec3d) {
      return computePath(
         new Vec3(mc.field_1724.method_23317(), mc.field_1724.method_23318(), mc.field_1724.method_23321()),
         new Vec3(vec3d.field_1352, vec3d.field_1351, vec3d.field_1350)
      );
   }
