...
public class ChatSetting_qVnAbgCzNciNTevKRovy extends Module_eSdgMXWuzcxgQVaJFmKZ {
   ...
   public final EnumSetting<FadeUtils> animQuad = this.add(new EnumSetting("Quad", FadeUtils.In));
   ...
   public final EnumSetting<ChatSetting> messageStyle = this.add(new EnumSetting("MessageStyle", ChatSetting.HexTech));
   public final EnumSetting<ChatSetting_FjbVfiTpsZbQdeUlhhhi> messageCode = this.add(new EnumSetting("MessageCode", ChatSetting_FjbVfiTpsZbQdeUlhhhi.HexTech));
