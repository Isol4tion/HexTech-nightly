...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    public final EnumSetting<ClickGui_lDjmIzzmqoIBLakgOLww> menu = this.add(new EnumSetting<ClickGui_lDjmIzzmqoIBLakgOLww>("MainMenu", ClickGui_lDjmIzzmqoIBLakgOLww.HexTech, v -> this.page.getValue() == ClickGui_PrFcfRftxumUysizqxkG.General));
    ...
    public final EnumSetting<ClickGui_qvrpuTqAQSFqXVuTIwHB> uiType = this.add(new EnumSetting<ClickGui_qvrpuTqAQSFqXVuTIwHB>("UIType", ClickGui_qvrpuTqAQSFqXVuTIwHB.Old, v -> this.page.getValue() == ClickGui_PrFcfRftxumUysizqxkG.General));
    ...
    public final EnumSetting<ClickGui> mode = this.add(new EnumSetting<ClickGui>("EnableAnim", ClickGui.Reset, v -> this.page.getValue() == ClickGui_PrFcfRftxumUysizqxkG.General));
