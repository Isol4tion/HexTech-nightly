...
public class NewBurrow_bHmPnkYIKEocVyqCgEHa extends Module_eSdgMXWuzcxgQVaJFmKZ {
   public static NewBurrow_bHmPnkYIKEocVyqCgEHa INSTANCE;
   public final EnumSetting<NewBurrow_CcRGSMXmJEPCxAQiPgnz> page = this.add(new EnumSetting("Page", NewBurrow_CcRGSMXmJEPCxAQiPgnz.Check));
   ...
   private final SliderSetting move = this.add(
      new SliderSetting("Move", 0.05, 0.0, 0.2, 0.01, v -> this.antiWebLag.isOpen() && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag))
   );
   ...
   private final BooleanSetting wait = this.add(
      new BooleanSetting("Wait", false, v -> this.disable.getValue() && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Check))
   );
   private final SliderSetting delay = this.add(
      new SliderSetting("Delay", 250, 0, 1000, v -> !this.disable.getValue() && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Place))
   );
   ...
   private final SliderSetting unNewBurrowWebTime = this.add(
      new SliderSetting("UnNewBurrowWebTime", 100, 0, 500, v -> this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Place))
   );
   ...
   private final EnumSetting<NewBurrow_qqQhaOJZqeVGcFBKpQgd> rotate = this.add(
      new EnumSetting("RotateMode", NewBurrow_qqQhaOJZqeVGcFBKpQgd.Bypass, v -> this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Place))
   );
   ...
   private final EnumSetting<NewBurrow> gotoMode = this.add(new EnumSetting("GotoMode", NewBurrow.Alien, v -> this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag)));
   ...
   private final BooleanSetting center = this.add(
      new BooleanSetting("AllowCenter", false, v -> this.fakeMove.isOpen() && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag))
   );
   private final EnumSetting<NewBurrow_SzzqAKQBmpOchBNTHTUz> lagMode = this.add(
      new EnumSetting("LagMode", NewBurrow_SzzqAKQBmpOchBNTHTUz.Smart, v -> this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag))
   );
   private final EnumSetting<NewBurrow_SzzqAKQBmpOchBNTHTUz> aboveLagMode = this.add(
      new EnumSetting("MoveLagMode", NewBurrow_SzzqAKQBmpOchBNTHTUz.Smart, v -> this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag))
   );
   private final SliderSetting smartDistance = this.add(
      new SliderSetting(
         ...
         10.0,
         0.1,
         v -> (this.lagMode.getValue() == NewBurrow_SzzqAKQBmpOchBNTHTUz.Smart || this.aboveLagMode.getValue() == NewBurrow_SzzqAKQBmpOchBNTHTUz.Smart)
               && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag)
      )
   );
   ...
   private final SliderSetting invalids = this.add(
      new SliderSetting(
         "Invalids",
         20.0,
         0.0,
         100.0,
         1.0,
         v -> (this.lagMode.getValue() == NewBurrow_SzzqAKQBmpOchBNTHTUz.Invalid || this.aboveLagMode.getValue() == NewBurrow_SzzqAKQBmpOchBNTHTUz.Invalid)
               && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag)
      )
   );
   private final SliderSetting height = this.add(
      new SliderSetting(
         "Height",
         -7.0,
         -10.0,
         10.0,
         0.1,
         v -> (this.lagMode.getValue() == NewBurrow_SzzqAKQBmpOchBNTHTUz.HexTech || this.aboveLagMode.getValue() == NewBurrow_SzzqAKQBmpOchBNTHTUz.HexTech)
               && this.page.is(NewBurrow_CcRGSMXmJEPCxAQiPgnz.Lag)
      )
   );
   ...
   public void onUpdate() {
      if (!nullCheck()) {
         ...
         if (me.hextech.HexTech.PLAYER.isInWeb(mc.field_1724)) {
            ...
            if (!this.checkClimb.getValue() || !mc.field_1724.method_20448()) {
               if (!this.pauseStep.getValue() || !Step_EShajbhvQeYkCdreEeNY.INSTANCE.isOn()) {
                  if (!me.hextech.HexTech.PLAYER.insideBlock && MovementUtil.isMoving()) {
                     if (!this.webTimer.passed(this.unNewBurrowWebTime.getValue())) {
                        return;
                     }
                  } else if (!this.webTimer.passed(this.webTime.getValue())) {
                     return;
                  }
                  ...
                  if (this.disable.getValue() || this.timer.passed(this.delay.getValue()) || this.Force) {
                     ...
                     if (mc.field_1724.method_24828()) {
                        if (!this.antiLag.getValue() || mc.field_1687.method_8320(EntityUtil.getPlayerPos().method_10074()).method_51366()) {
                           if (!Blink.INSTANCE.isOn()) {
                              int oldSlot = mc.field_1724.method_31548().field_7545;
                              int block;
                              if ((block = this.getBlock()) == -1) {
                                 CommandManager.sendChatMessageWidthId(
                                    "§c§oObsidian" + (this.enderChest.getValue() ? "/EnderChest" : "") + "?", this.hashCode()
                                 );
                                 this.disable();
                              } else {
                                 this.progress = 0;
                                 ...
                                 BlockPos pos1 = new BlockPosX(
                                    mc.field_1724.method_23317() + offset, mc.field_1724.method_23318() + 0.15, mc.field_1724.method_23321() + offset
                                 );
                                       ...
                                       if (!moved) {
                                          for (Direction facingx : Direction.values()) {
                                             if (facingx != Direction.field_11036 && facingx != Direction.field_11033) {
                                                BlockPos var37 = playerPos.method_10093(facingx);
                                                if (this.checkSelf(var37)) {
                                                   this.gotoPos(var37);
                                                   moved = true;
                                                   break;
                                                }
                                          ...
                                          if (!moved) {
                                             ...
                                             for (Direction facingxx : Direction.values()) {
                                                if (facingxx != Direction.field_11036 && facingxx != Direction.field_11033) {
                                                   BlockPos var38 = playerPos.method_10093(facingxx);
                                                   if (this.canMove(var38)) {
                                                      this.gotoPos(var38);
                                                      moved = true;
                                                      break;
                                                   }
                                 ...
                                 switch (this.above
                                    ? (NewBurrow_SzzqAKQBmpOchBNTHTUz)this.aboveLagMode.getValue()
                                    : (NewBurrow_SzzqAKQBmpOchBNTHTUz)this.lagMode.getValue()) {
                                    case Smart:
                                       ...
                                       break;
                                    case Invalid:
                                       for (int i = 0; (double)i < this.invalids.getValue(); i++) {
                                          mc.method_1562()
                                             .method_52787(
                                                new PositionAndOnGround(
                                    ...
                                    case Fly:
                                       mc.method_1562()
                                          .method_52787(
                                             new PositionAndOnGround(
                                                mc.field_1724.method_23317(),
                                                mc.field_1724.method_23318() + 1.16610926093821,
                                                mc.field_1724.method_23321(),
                                                false
                                             )
                                          );
                                       mc.method_1562()
                                          .method_52787(
                                             new PositionAndOnGround(
                                                mc.field_1724.method_23317(),
                                                mc.field_1724.method_23318() + 1.170005801788139,
                                                mc.field_1724.method_23321(),
                                                false
                                             )
                                          );
                                       mc.method_1562()
                                          .method_52787(
                                             new PositionAndOnGround(
                                                mc.field_1724.method_23317(),
                                                mc.field_1724.method_23318() + 1.2426308013947485,
                                                mc.field_1724.method_23321(),
                                                false
                                             )
                                          );
                                       ...
                                       mc.method_1562()
                                          .method_52787(
                                             new PositionAndOnGround(
                                                mc.field_1724.method_23317(),
                                                mc.field_1724.method_23318() + 2.640088003576279,
                                                mc.field_1724.method_23321(),
                                                false
                                             )
                                          );
                                    ...
                                    case HexTech:
                                       mc.method_1562()
                                          .method_52787(
                                             new PositionAndOnGround(
                                                mc.field_1724.method_23317(),
                                                mc.field_1724.method_23318() + this.height.getValue(),
                                                mc.field_1724.method_23321(),
                                                false
                                             )
                                          );
   ...
   private void gotoPos(BlockPos offPos) {
      if (this.gotoMode.is(NewBurrow.Alien)) {
         if (this.rotate.getValue() == NewBurrow_qqQhaOJZqeVGcFBKpQgd.None) {
            mc.method_1562()
               .method_52787(
                  new PositionAndOnGround(
                     (double)offPos.method_10263() + 0.5, mc.field_1724.method_23318() + this.moveUp.getValue(), (double)offPos.method_10260() + 0.5, false
                  )
               );
         } else {
            mc.method_1562()
               .method_52787(
                  new Full(
                     ...
                     mc.field_1724.method_23318() + this.moveUp.getValue(),
      ...
      } else if (Math.abs((double)offPos.method_10263() + 0.5 - mc.field_1724.method_23317())
