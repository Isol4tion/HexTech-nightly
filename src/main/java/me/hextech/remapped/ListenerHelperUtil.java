...
implements Wrapper {
    ...
    public static boolean canTouch(BlockPos pos) {
        ...
        if (ListenerHelperUtil.mc.field_1724 == null) return false;
        ...
        if (!(pos.method_46558().method_1019(vec3d).method_1022(ListenerHelperUtil.mc.field_1724.method_33571()) <= AutoCrystal_QcRVYRsOqpKivetoXSJa.INSTANCE.range.getValue())) return false;
        return true;
    }
    ...
    public static boolean behindWall(BlockPos pos) {
        ...
        if (ListenerHelperUtil.mc.field_1687 != null && ListenerHelperUtil.mc.field_1724 != null) {
            result = ListenerHelperUtil.mc.field_1687.method_17742(new RaycastContext(EntityUtil.getEyesPos(), testVec, RaycastContext.ShapeType.field_17558, RaycastContext.FluidHandling.field_1348, (Entity)ListenerHelperUtil.mc.field_1724));
        }
        if (result == null || result.method_17783() == HitResult.Type.field_1333) {
            return false;
        }
        return ListenerHelperUtil.mc.field_1724.method_33571().method_1022(pos.method_46558().method_1031(0.0, -0.5, 0.0)) > AutoCrystal_QcRVYRsOqpKivetoXSJa.INSTANCE.range.getValue();
    }

    public static boolean canSee(Vec3d from, Vec3d to) {
        BlockHitResult result = null;
        if (ListenerHelperUtil.mc.field_1687 != null && ListenerHelperUtil.mc.field_1724 != null) {
            result = ListenerHelperUtil.mc.field_1687.method_17742(new RaycastContext(from, to, RaycastContext.ShapeType.field_17558, RaycastContext.FluidHandling.field_1348, (Entity)ListenerHelperUtil.mc.field_1724));
        }
    ...
    private static boolean noEntityBlockCrystal(BlockPos pos, boolean ignoreCrystal, boolean ignoreItem) {
        if (ListenerHelperUtil.mc.field_1687 != null) {
            for (Entity entity : ListenerHelperUtil.mc.field_1687.method_18467(Entity.class, new Box(pos))) {
                ...
                if (entity instanceof EndCrystalEntity) {
                    ...
                    if (ListenerHelperUtil.mc.field_1724 != null && (ListenerHelperUtil.mc.field_1724.method_6057(entity) || ListenerHelperUtil.mc.field_1724.method_33571().method_1022(entity.method_19538()) <= AutoCrystal_QcRVYRsOqpKivetoXSJa.INSTANCE.range.getValue())) continue;
                }
                return false;
            }
        }
