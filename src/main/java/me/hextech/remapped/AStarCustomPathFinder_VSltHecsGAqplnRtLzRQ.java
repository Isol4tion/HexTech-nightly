...
implements Wrapper {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        return AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320((BlockPos)block).field_23166 != null && AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320((BlockPos)block).field_23166.isFullCube || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof SlabBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof StairsBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof CactusBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof ChestBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof EnderChestBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof SkullBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof PaneBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof FenceBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof WallBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof StainedGlassBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof PistonBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof PistonExtensionBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof PistonHeadBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof StainedGlassBlock || AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof TrapdoorBlock;
    }

    private static boolean isSafeToWalkOn(BlockPos block) {
        return !(AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof FenceBlock) && !(AStarCustomPathFinder_VSltHecsGAqplnRtLzRQ.mc.world.method_8320(block).method_26204() instanceof WallBlock);
    }
