...
extends Command {
    ...
    public void runCommand(String[] parameters) {
        ...
        if (parameters.length == 1) {
            ConfigManager.options = new File(SaveCommand.mc.field_1697, parameters[0] + ".cfg");
            HexTech.save();
            ConfigManager.options = new File(SaveCommand.mc.field_1697, "nullpoint_options.txt");
        }
        HexTech.save();
    }
