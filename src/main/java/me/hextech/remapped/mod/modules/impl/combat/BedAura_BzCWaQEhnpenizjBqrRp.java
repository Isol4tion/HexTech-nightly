...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    private final EnumSetting<Enum_IKgLeKHCELPvcpdGlLhV> calcMode = this.add(new EnumSetting<Enum_IKgLeKHCELPvcpdGlLhV>("CalcMode", Enum_IKgLeKHCELPvcpdGlLhV.OyVey, v -> this.page.getValue() == Page.General));
