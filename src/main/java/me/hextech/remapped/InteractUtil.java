...
public class InteractUtil implements Wrapper {
   public static HitResult getRtxTarget(float yaw, float pitch, double x, double y, double z) {
      ...
      Vec3d vec3d = new Vec3d(x, y, z).method_1031(0.0, (double)mc.field_1724.method_18381(mc.field_1724.method_18376()), 0.0);
      ...
      Box box = new Box(x - 0.3, y, z - 0.3, x + 0.3, y + (double)mc.field_1724.method_18381(mc.field_1724.method_18376()), z + 0.3)
         .method_18804(vec3d2.method_1021(5.0))
         .method_1009(1.0, 1.0, 1.0);
      EntityHitResult entityHitResult = ProjectileUtil.method_18075(
         mc.field_1724, vec3d, vec3d3, box, entity -> !entity.method_7325() && entity.method_5863(), distancePow2
      );
   ...
   public static HitResult rayTrace(double dst, float yaw, float pitch, double x, double y, double z) {
      ...
      return mc.field_1687.method_17742(new RaycastContext(vec3d, vec3d3, ShapeType.field_17559, FluidHandling.field_1348, mc.field_1724));
   }

   private static Vec3d getRotationVector(float yaw, float pitch) {
      return new Vec3d(
         (double)(MathHelper.method_15374(-pitch * (float) (Math.PI / 180.0)) * MathHelper.method_15362(yaw * (float) (Math.PI / 180.0))),
         (double)(-MathHelper.method_15374(yaw * (float) (Math.PI / 180.0))),
         (double)(MathHelper.method_15362(-pitch * (float) (Math.PI / 180.0)) * MathHelper.method_15362(yaw * (float) (Math.PI / 180.0)))
      );
   }
}
