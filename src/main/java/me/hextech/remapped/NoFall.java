...
public class NoFall extends Module_eSdgMXWuzcxgQVaJFmKZ {
   ...
   public void onPacketSend(PacketEvent event) {
      if (!nullCheck()) {
         for (ItemStack is : mc.field_1724.method_5661()) {
            if (is.method_7909() == Items.field_8833) {
               return;
            }
         }

         if (event.getPacket() instanceof PlayerMoveC2SPacket packet && mc.field_1724.field_6017 >= (float)this.distance.getValue()) {
