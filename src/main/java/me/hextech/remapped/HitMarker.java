...
public class HitMarker extends Module_eSdgMXWuzcxgQVaJFmKZ {
      ...
      if (this.timer.passedMs(0L)) {
         ...
         if ((float)this.ticks <= this.time.getValueFloat()) {
            ...
            drawContext.method_25291(
               this.marker, mc.method_22683().method_4486() / 2 - 8, mc.method_22683().method_4502() / 2 - 8, 0, 0.0F, 0.0F, 16, 16, 16, 16
            );
         }
      }
   }
