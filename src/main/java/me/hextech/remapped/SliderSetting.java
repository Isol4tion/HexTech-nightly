...
public class SliderSetting extends Setting {
   ...
   public SliderSetting(String name, int value, int min, int max, Predicate visibilityIn) {
      this(name, (double)value, (double)min, (double)max, 1.0, visibilityIn);
   }
   ...
   public void loadSetting() {
      this.setValue((double)me.hextech.HexTech.CONFIG.getFloat(this.getLine(), (float)this.defaultValue));
   }
      ...
      switch (keyCode) {
         case 86:
            if (InputUtil.method_15987(Wrapper.mc.method_22683().method_4490(), 341)) {
               this.temp = this.temp + SelectionManager.method_27556(Wrapper.mc);
            }
            break;
         case 256:
         case 257:
         case 335:
            if (this.temp.isEmpty()) {
               ...
               this.setValue((double)Float.parseFloat(this.temp));
               this.update = true;
            }
            ...
            break;
         case 259:
            this.temp = removeLastChar(this.temp);
      }
   }
