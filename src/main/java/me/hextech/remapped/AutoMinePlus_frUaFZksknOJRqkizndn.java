...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    public void onUpdate() {
        ...
        if (AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1687.method_8320(pos).method_26204() == Blocks.field_9987 && this.checkBedrock.getValue()) {
            return;
        }
        this.doBreak(player);
    }
    ...
    private void doBreak(PlayerEntity player) {
        ...
        if (this.down.getValue()) {
            if (this.smart.getValue() && (double)(player.method_24515().method_10264() - AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_24515().method_10264()) > this.yandy.getValue()) {
        ...
        if (this.surround.getValue()) {
            if (this.mineMode.getValue() == AutoMinePlus.Normal) {
                ...
                for (Direction direction : Direction.values()) {
                    if (direction == Direction.field_11036 || direction == Direction.field_11033 || Math.sqrt(AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_33571().method_1025(pos.method_10093(direction).method_46558())) > this.range.getValue() || !AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1687.method_22347(pos.method_10093(direction)) && !pos.method_10093(direction).equals((Object)SpeedMine.getBreakPos()) || !this.canPlaceCrystal(pos.method_10093(direction), false)) continue;
                    return;
                }
                ...
                while (var6_24 < n) {
                    ...
                    if (i != Direction.field_11036 && i != Direction.field_11033 && !(Math.sqrt(AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_33571().method_1025(pos.method_10093(i).method_46558())) > this.range.getValue()) && this.canBreak(pos.method_10093(i)) && this.canPlaceCrystal(pos.method_10093(i), true)) {
                        arrayList.add(pos.method_10093(i));
                    }
                    ++var6_24;
                }
                if (!arrayList.isEmpty()) {
                    SpeedMine.INSTANCE.mine(arrayList.stream().min(Comparator.comparingDouble(E -> E.method_19770((Position)AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_33571()))).get());
                } else {
                    void var6_26;
                    ...
                    while (var6_26 < n) {
                        ...
                        if (i != Direction.field_11036 && i != Direction.field_11033 && !(Math.sqrt(AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_33571().method_1025(pos.method_10093(i).method_46558())) > this.range.getValue()) && this.canBreak(pos.method_10093(i)) && this.canPlaceCrystal(pos.method_10093(i), false)) {
                            arrayList.add(pos.method_10093(i));
                        }
                        ++var6_26;
                    }
                ...
                void var6_34;
                for (Direction direction : Direction.values()) {
                    if (direction == Direction.field_11036 || direction == Direction.field_11033 || Math.sqrt(AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_33571().method_1025(pos.method_10093(direction).method_46558())) > this.range.getValue() || !pos.method_10093(direction).equals((Object)SpeedMine.getBreakPos()) || SpeedMine.secondPos != null) continue;
                    return;
                }
                ArrayList<BlockPos> arrayList = new ArrayList<BlockPos>();
                Direction[] directionArray = Direction.values();
    ...
    public boolean canPlaceCrystal(BlockPos pos, boolean block) {
        ...
        return (BlockUtil.getBlock(obsPos) == Blocks.field_9987 || BlockUtil.getBlock(obsPos) == Blocks.field_10540 || !block) && !BlockUtil.hasEntityBlockCrystal(boost, true, true) && !BlockUtil.hasEntityBlockCrystal(boost.method_10084(), true, true);
    }

    public boolean isObsidian(BlockPos pos) {
        return AutoMinePlus_frUaFZksknOJRqkizndn.mc.field_1724.method_33571().method_1022(pos.method_46558()) <= this.range.getValue() && (BlockUtil.getBlock(pos) == Blocks.field_10540 || BlockUtil.getBlock(pos) == Blocks.field_10443 || BlockUtil.getBlock(pos) == Blocks.field_22108 || BlockUtil.getBlock(pos) == Blocks.field_23152) && BlockUtil.getClickSide(pos) != null;
    }
