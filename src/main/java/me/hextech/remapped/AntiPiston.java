...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    public void onUpdate() {
        ...
        if (this.usingPause.getValue() && AntiPiston.mc.field_1724.method_6115()) {
            return;
        }
        this.block();
    }
    ...
    private void block() {
        ...
        if (this.moveUp.getValue()) {
            ...
            for (Direction i : Direction.values()) {
                if (i == Direction.field_11033 || i == Direction.field_11036 || !(this.getBlock(pos.method_10093(i).method_10084()) instanceof PistonBlock) || ((Direction)AntiPiston.mc.field_1687.method_8320(pos.method_10093(i).method_10084()).method_11654((Property)FacingBlock.field_10927)).method_10153() != i) {
                    if (this.webUpdate((PlayerEntity)AntiPiston.mc.field_1724)) continue;
                    canMove = true;
                    continue;
                }
                if (!canMove) continue;
                mc.method_1562().method_52787((Packet)new PlayerMoveC2SPacket.PositionAndOnGround(AntiPiston.mc.field_1724.method_23317(), AntiPiston.mc.field_1724.method_23318() + 0.4199999868869781, AntiPiston.mc.field_1724.method_23321(), false));
                mc.method_1562().method_52787((Packet)new PlayerMoveC2SPacket.PositionAndOnGround(AntiPiston.mc.field_1724.method_23317(), AntiPiston.mc.field_1724.method_23318() + 0.7531999805212017, AntiPiston.mc.field_1724.method_23321(), false));
                AntiPiston.mc.field_1724.method_5814(AntiPiston.mc.field_1724.method_23317(), AntiPiston.mc.field_1724.method_23318() + 1.0, AntiPiston.mc.field_1724.method_23321());
                mc.method_1562().method_52787((Packet)new PlayerMoveC2SPacket.PositionAndOnGround(AntiPiston.mc.field_1724.method_23317(), AntiPiston.mc.field_1724.method_23318(), AntiPiston.mc.field_1724.method_23321(), true));
                canMove = false;
            }
        }
        ...
        if (this.whenDouble.getValue()) {
            for (Direction i : Direction.values()) {
                if (i == Direction.field_11033 || i == Direction.field_11036 || !(this.getBlock(pos.method_10093(i).method_10084()) instanceof PistonBlock) || ((Direction)AntiPiston.mc.field_1687.method_8320(pos.method_10093(i).method_10084()).method_11654((Property)FacingBlock.field_10927)).method_10153() != i) continue;
                ++progress;
            }
        }
        if (!this.webUpdate((PlayerEntity)AntiPiston.mc.field_1724)) {
            AntiPiston.mc.field_1724.method_5814(AntiPiston.mc.field_1724.method_23317(), AntiPiston.mc.field_1724.method_23318() + 3.0, AntiPiston.mc.field_1724.method_23321());
            mc.method_1562().method_52787((Packet)new PlayerMoveC2SPacket.PositionAndOnGround(AntiPiston.mc.field_1724.method_23317(), AntiPiston.mc.field_1724.method_23318(), AntiPiston.mc.field_1724.method_23321(), true));
        }
        for (Direction i : Direction.values()) {
            if (i == Direction.field_11033 || i == Direction.field_11036 || !(this.getBlock(pos.method_10093(i).method_10084()) instanceof PistonBlock) || ((Direction)AntiPiston.mc.field_1687.method_8320(pos.method_10093(i).method_10084()).method_11654((Property)FacingBlock.field_10927)).method_10153() != i) continue;
            this.placeBlock(pos.method_10084().method_10079(i, -1));
            if (this.trap.getValue() && (this.getBlock(pos) != Blocks.field_10124 || !this.onlyBurrow.getValue() || progress >= 2)) {
                ...
                if (!BlockUtil.canPlace(pos.method_10086(2))) {
                    for (Direction i2 : Direction.values()) {
                        if (!AntiPiston.canPlace(pos.method_10093(i2).method_10086(2))) continue;
                        this.placeBlock(pos.method_10093(i2).method_10086(2));
                        break;
                    }
                }
            }
            if (BlockUtil.canPlace(pos.method_10084().method_10079(i, -1)) || !this.helper.getValue()) continue;
    ...
    private Block getBlock(BlockPos block) {
        return AntiPiston.mc.field_1687.method_8320(block).method_26204();
    }
    ...
    private void placeBlock(BlockPos pos) {
        ...
        int old = AntiPiston.mc.field_1724.method_31548().field_7545;
    ...
    private void doSwap(int slot) {
        if (this.inventory.getValue()) {
            InventoryUtil.inventorySwap(slot, AntiPiston.mc.field_1724.method_31548().field_7545);
        } else {
        ...
        for (float x : new float[]{0.0f, 0.3f, -0.3f}) {
            for (float z : new float[]{0.0f, 0.3f, -0.3f}) {
                for (int y : new int[]{-1, 0, 1, 2}) {
                    ...
                    if (!new Box(pos).method_994(player.method_5829()) || AntiPiston.mc.field_1687.method_8320(pos).method_26204() != Blocks.field_10343) continue;
                    return true;
                }
            }
        }
