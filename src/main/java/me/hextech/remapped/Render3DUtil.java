...
public class Render3DUtil implements Wrapper {
   public static MatrixStack matrixFrom(double x, double y, double z) {
      ...
      Camera camera = mc.field_1773.method_19418();
   ...
   public static void drawText3D(String text, Vec3d vec3d, Color color) {
      drawText3D(Text.method_30163(text), vec3d.field_1352, vec3d.field_1351, vec3d.field_1350, 0.0, 0.0, 0.9, color.getRGB());
   }

   public static void drawText3D(String text, Vec3d vec3d, int color) {
      drawText3D(Text.method_30163(text), vec3d.field_1352, vec3d.field_1351, vec3d.field_1350, 0.0, 0.0, 1.0, color);
   }

   public static void drawText3DMine(String text, Vec3d vec3d, int color) {
      drawText3D(
         Text.method_30163(text), vec3d.field_1352, vec3d.field_1351, vec3d.field_1350, 0.0, 0.0, (double)SpeedMine.INSTANCE.textscale.getValueFloat(), color
      );
   }

   public static void drawText3DSlient(String text, Vec3d vec3d, int color) {
      drawText3D(
         Text.method_30163(text),
         vec3d.field_1352,
         vec3d.field_1351,
         vec3d.field_1350,
         0.0,
         (double)SpeedMine.INSTANCE.doubletext.getValueFloat(),
         (double)SpeedMine.INSTANCE.textscale.getValueFloat(),
         color
      );
   }
   ...
   public static void drawText3DBreak(String text, Vec3d vec3d, int color) {
      drawText3D(
         Text.method_30163(text), vec3d.field_1352, vec3d.field_1351, vec3d.field_1350, 0.0, 0.0, (double)BreakESP.INSTANCE.namescale.getValueFloat(), color
      );
   }

   public static void drawText3DBreakMine(Text text, Vec3d vec3d, double offX, double offY, double scale, Color color) {
      drawText3D(text, vec3d.field_1352, vec3d.field_1351, vec3d.field_1350, offX, offY, scale, color.getRGB());
   }
   ...
   public static void drawText3D(Text text, double x, double y, double z, double offX, double offY, double scale, int color) {
      ...
      int halfWidth = mc.field_1772.method_27525(text) / 2;
      Immediate immediate = VertexConsumerProvider.method_22991(Tessellator.method_1348().method_1349());
      matrices.method_22903();
      matrices.method_46416(1.0F, 1.0F, 0.0F);
      mc.field_1772
         .method_30882(
            Text.method_30163(text.getString().replaceAll("§[a-zA-Z0-9]", "")),
            (float)(-halfWidth),
            0.0F,
            2105376,
            false,
   ...
   public static void drawTextIn3D(String text, Vec3d pos, double offX, double offY, double textOffset, Color color) {
      ...
      matrices.method_22904(
         pos.method_10216() - camera.method_19326().field_1352,
         pos.method_10214() - camera.method_19326().field_1351,
         pos.method_10215() - camera.method_19326().field_1350
      );
      matrices.method_22907(RotationAxis.field_40716.rotationDegrees(-camera.method_19330()));
      matrices.method_22907(RotationAxis.field_40714.rotationDegrees(camera.method_19329()));
      RenderSystem.enableBlend();
   ...
   public static void drawFadingBox(MatrixStack matrixStack, Box pos, Color startColor, Color endColor, double height) {
      for (Direction face : Direction.values()) {
         if (face != Direction.field_11036) {
            drawFadingSide(matrixStack, pos, face, startColor, endColor, height);
         }
      }
   }
   ...
   public static void drawFadingSide(MatrixStack matrixStack, Box bb, Direction face, Color startColor, Color endColor, double height) {
      ...
      if (face == Direction.field_11034 || face == Direction.field_11039 || face == Direction.field_11043 || face == Direction.field_11035) {
         buildPosColor(matrix, bufferBuilder, red, green, blue, alpha, red2, green2, blue2, alpha2, x1, y1, z1, x2, y2, z2);
      } else if (face == Direction.field_11036) {
         buildPosColor(matrix, bufferBuilder, red2, green2, blue2, alpha2, x1, y1, z1, x2, y2, z2);
      } else if (face == Direction.field_11033) {
         buildPosColor(matrix, bufferBuilder, red, green, blue, alpha, x1, y1, z1, x2, y2, z2);
      }
   ...
   private static void buildPosColor(
      ...
      buildPosColor(matrix, builder, red2, green2, blue2, alpha2, red2, green2, blue2, alpha2, x1, y1, z1, x2, y2, z2);
   }
   ...
   public static void drawLine(Box b, Color color, float lineWidth) {
      ...
      RenderSystem.defaultBlendFunc();
      RenderSystem.disableDepthTest();
      MatrixStack matrices = matrixFrom(b.field_1323, b.field_1322, b.field_1321);
      Tessellator tessellator = RenderSystem.renderThreadTesselator();
      BufferBuilder buffer = tessellator.method_1349();
      RenderSystem.disableCull();
      RenderSystem.setShader(GameRenderer::method_34535);
      RenderSystem.lineWidth(lineWidth);
      buffer.method_1328(DrawMode.field_27377, VertexFormats.field_29337);
      ...
      vertexLine(matrices, buffer, (double)x1, (double)y1, (double)z1, (double)x2, (double)y1, (double)z1, color);
      vertexLine(matrices, buffer, (double)x2, (double)y1, (double)z1, (double)x2, (double)y1, (double)z2, color);
      vertexLine(matrices, buffer, (double)x2, (double)y1, (double)z2, (double)x1, (double)y1, (double)z2, color);
      vertexLine(matrices, buffer, (double)x1, (double)y1, (double)z2, (double)x1, (double)y1, (double)z1, color);
      vertexLine(matrices, buffer, (double)x1, (double)y1, (double)z2, (double)x1, (double)y2, (double)z2, color);
      vertexLine(matrices, buffer, (double)x1, (double)y1, (double)z1, (double)x1, (double)y2, (double)z1, color);
      vertexLine(matrices, buffer, (double)x2, (double)y1, (double)z2, (double)x2, (double)y2, (double)z2, color);
      vertexLine(matrices, buffer, (double)x2, (double)y1, (double)z1, (double)x2, (double)y2, (double)z1, color);
      vertexLine(matrices, buffer, (double)x1, (double)y2, (double)z1, (double)x2, (double)y2, (double)z1, color);
      vertexLine(matrices, buffer, (double)x2, (double)y2, (double)z1, (double)x2, (double)y2, (double)z2, color);
      vertexLine(matrices, buffer, (double)x2, (double)y2, (double)z2, (double)x1, (double)y2, (double)z2, color);
      vertexLine(matrices, buffer, (double)x1, (double)y2, (double)z2, (double)x1, (double)y2, (double)z1, color);
      tessellator.method_1350();
      RenderSystem.enableCull();
      RenderSystem.enableDepthTest();
      RenderSystem.disableBlend();
   ...
   public static void drawSphere(MatrixStack matrix, EndCrystalEntity entity, Float radius, Float height, Float lineWidth, Color color) {
      ...
      for (int i = 0; i <= 180; i++) {
         bufferBuilder.method_22918(
               matrix.method_23760().method_23761(),
               (float)(x + (double)radius.floatValue() * Math.cos((double)i * pix2 / 45.0)),
               (float)(y + (double)height.floatValue()),
               (float)(z + (double)radius.floatValue() * Math.sin((double)i * pix2 / 45.0))
            )
   ...
   public static void draw3DBox(MatrixStack matrixStack, Box box, Color color, boolean outline, boolean fill) {
      box = box.method_997(mc.field_1773.method_19418().method_19326().method_22882());
      RenderSystem.enableBlend();
      GL11.glDisable(2929);
      Matrix4f matrix = matrixStack.method_23760().method_23761();
      Tessellator tessellator = RenderSystem.renderThreadTesselator();
      ...
      if (outline) {
         ...
         bufferBuilder.method_1328(DrawMode.field_29344, VertexFormats.field_1592);
   ...
   public static void drawHole(MatrixStack matrixStack, BlockPos pos, Color color, boolean outline, boolean fill, float height, float lineWidth) {
      ...
      if (fill) {
         ...
         bufferBuilder.method_22918(matrix, (float)box.field_1323, (float)box.field_1322, (float)box.field_1321)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha())
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1323, (float)box.field_1322 + height, (float)box.field_1321)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), 0)
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1320, (float)box.field_1322 + height, (float)box.field_1321)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), 0)
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1320, (float)box.field_1322, (float)box.field_1321)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha())
         ...
         bufferBuilder.method_22918(matrix, (float)box.field_1320, (float)box.field_1322 + height, (float)box.field_1321)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), 0)
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1320, (float)box.field_1322 + height, (float)box.field_1324)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), 0)
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1320, (float)box.field_1322, (float)box.field_1324)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha())
         ...
         bufferBuilder.method_22918(matrix, (float)box.field_1320, (float)box.field_1322 + height, (float)box.field_1324)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), 0)
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1323, (float)box.field_1322 + height, (float)box.field_1324)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), 0)
            .method_1344();
         bufferBuilder.method_22918(matrix, (float)box.field_1323, (float)box.field_1322, (float)box.field_1321)
            .method_1336(color.getRed(), color.getGreen(), color.getBlue(), color.getAlpha())
   ...
   public static void drawLine(double x1, double y1, double z1, double x2, double y2, double z2, Color color, float width) {
      ...
      buffer.method_1328(DrawMode.field_27377, VertexFormats.field_29337);
      vertexLine(matrices, buffer, 0.0, 0.0, 0.0, (double)((float)(x2 - x1)), (double)((float)(y2 - y1)), (double)((float)(z2 - z1)), color);
      tessellator.method_1350();
      RenderSystem.enableCull();
   ...
   public static void vertexLine(MatrixStack matrices, VertexConsumer buffer, double x1, double y1, double z1, double x2, double y2, double z2, Color lineColor) {
      ...
      buffer.method_22918(model, (float)x1, (float)y1, (float)z1)
         .method_1336(lineColor.getRed(), lineColor.getGreen(), lineColor.getBlue(), lineColor.getAlpha())
         .method_23763(normal, normalVec.x(), normalVec.y(), normalVec.z())
         .method_1344();
      buffer.method_22918(model, (float)x2, (float)y2, (float)z2)
         .method_1336(lineColor.getRed(), lineColor.getGreen(), lineColor.getBlue(), lineColor.getAlpha())
         .method_23763(normal, normalVec.x(), normalVec.y(), normalVec.z())
         .method_1344();
   }
   ...
   public static Vector3f getNormal(float x1, float y1, float z1, float x2, float y2, float z2) {
      ...
      float yNormal = y2 - y1;
      float zNormal = z2 - z1;
      float normalSqrt = MathHelper.method_15355(xNormal * xNormal + yNormal * yNormal + zNormal * zNormal);
   ...
   public static void drawHoleBox(MatrixStack matrixStack, Box box, Color color, double height, boolean fade, boolean invertFade, int alpha) {
      if (fade) {
         ...
         drawFadingBox(matrixStack, box, invertFade ? endColor : color, invertFade ? color : endColor, height);
      } else {
         GL11.glEnable(3042);
         GL11.glDisable(2929);
         Matrix4f matrix = matrixStack.method_23760().method_23761();
