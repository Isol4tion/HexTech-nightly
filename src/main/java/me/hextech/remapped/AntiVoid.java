...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    public void onUpdate() {
        ...
        for (int i = (int)AntiVoid.mc.field_1724.method_23318(); i > this.voidHeight.getValueInt() - 1; --i) {
            if (AntiVoid.mc.field_1687.method_8320((BlockPos)new BlockPosX(AntiVoid.mc.field_1724.method_23317(), i, AntiVoid.mc.field_1724.method_23321())).method_26204() == Blocks.field_10124) continue;
            isVoid = false;
            break;
        }
