...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    public void onRender3D(MatrixStack matrixStack, float partialTicks) {
        ...
        if ((double)chest >= this.count.getValue()) {
            this.timer.reset();
            BaseFinder.writePacketData(basedata, "Find:" + String.valueOf(BaseFinder.mc.field_1724.method_19538()) + " Count:" + chest);
            CommandManager.sendChatMessage("Find:" + String.valueOf(BaseFinder.mc.field_1724.method_19538()) + " Count:" + chest);
            chest = 0;
        }
    }
}
