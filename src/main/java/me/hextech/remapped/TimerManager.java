...
public class TimerManager {
   ...
   public void setMs(long ms) {
      this.timer = (float)(System.nanoTime() - this.convertToNS(ms));
   }
   ...
   public float getDefault() {
      return IncreasesTime.INSTANCE.isOn()
         ? (IncreasesTime.INSTANCE.activekey.isPressed() ? IncreasesTime.INSTANCE.active.getValueFloat() : IncreasesTime.INSTANCE.multiplier.getValueFloat())
         : 1.0F;
   }
}
