...
class AStarCustomPathFinder_GIsiOdvkuKbgFcjrKqrl {
   private Vec3 loc;
   ...
   public AStarCustomPathFinder_GIsiOdvkuKbgFcjrKqrl(
      Vec3 loc, AStarCustomPathFinder_GIsiOdvkuKbgFcjrKqrl parent, ArrayList<Vec3> path, double squareDistanceToFromTarget, double cost, double totalCost
   ) {
      this.loc = loc;
      this.parent = parent;
      this.path = path;
