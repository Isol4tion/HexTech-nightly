...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    private boolean canBreak(BlockPos pos) {
        return (BlockUtil.getClickSideStrict(pos) != null || SpeedMine.breakPos.equals((Object)pos)) && !SpeedMine.godBlocks.contains(AntiCrawl.mc.world.getBlockState(pos).getBlock()) && !AntiCrawl.mc.world.isAir(pos);
    }
}
