...
implements Wrapper {
    ...
    public static double getJumpSpeed() {
        ...
        if (MovementUtil.mc.field_1724.method_6059(StatusEffects.field_5913)) {
            int amplifier = ((StatusEffectInstance)MovementUtil.mc.field_1724.method_6088().get(StatusEffects.field_5913)).method_5578();
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        float yaw = MovementUtil.mc.field_1724.method_36454();
    ...
    public static double[] directionSpeed(double speed) {
        ...
        float yaw = MovementUtil.mc.field_1724.field_5982 + (MovementUtil.mc.field_1724.method_36454() - MovementUtil.mc.field_1724.field_5982) * mc.method_1488();
        if (forward != 0.0f) {
            if (side > 0.0f) {
    ...
    public static double getSpeed(boolean slowness, double defaultSpeed) {
        int amplifier;
        if (MovementUtil.mc.field_1724.method_6059(StatusEffects.field_5904)) {
            amplifier = ((StatusEffectInstance)MovementUtil.mc.field_1724.method_6088().get(StatusEffects.field_5904)).method_5578();
            defaultSpeed *= 1.0 + 0.2 * (double)(amplifier + 1);
        }
        if (slowness && MovementUtil.mc.field_1724.method_6059(StatusEffects.field_5909)) {
            amplifier = ((StatusEffectInstance)MovementUtil.mc.field_1724.method_6088().get(StatusEffects.field_5909)).method_5578();
            defaultSpeed /= 1.0 + 0.2 * (double)(amplifier + 1);
        }
