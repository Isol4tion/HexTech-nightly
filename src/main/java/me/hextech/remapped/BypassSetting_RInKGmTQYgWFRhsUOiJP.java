...
public class BypassSetting_RInKGmTQYgWFRhsUOiJP extends Module_eSdgMXWuzcxgQVaJFmKZ {
   public static BypassSetting_RInKGmTQYgWFRhsUOiJP INSTANCE;
   public final EnumSetting<BypassSetting> page = this.add(new EnumSetting("Page", BypassSetting.NCP));
