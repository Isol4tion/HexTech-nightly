...
public class ItemHUD extends Module_eSdgMXWuzcxgQVaJFmKZ {
   ...
   public void onRender2D(DrawContext drawContext, float tickDelta) {
      ...
      list.add(new ItemStack(Items.field_8367, this.getItemCount(Items.field_8367)));
      list.add(new ItemStack(Items.field_8288, this.getItemCount(Items.field_8288)));
      list.add(new ItemStack(Items.field_8301, this.getItemCount(Items.field_8301)));
      list.add(new ItemStack(Items.field_23141, this.getItemCount(Items.field_23141)));
      list.add(new ItemStack(Items.field_8801, this.getItemCount(Items.field_8801)));
      list.add(new ItemStack(Items.field_8249, this.getItemCount(Items.field_8249)));
      list.add(new ItemStack(Items.field_8793, this.getItemCount(Items.field_8793)));
      list.add(new ItemStack(Items.field_8786, this.getItemCount(Items.field_8786)));
      list.add(new ItemStack(Items.field_8287, this.getItemCount(Items.field_8287)));
      ...
      for (int i = 0; i < list.size(); i++) {
         ...
         drawItem(
            ...
            this.xOffset.getValueInt() + this.xPlus.getValueInt() * i,
            this.yOffset.getValueInt(),
            this.scale.getValueFloat()
         );
         ...
         if (((ItemStack)list.get(i)).method_7947() != Integer.MAX_VALUE) {
            TextUtil.drawString(
               drawContext,
               String.valueOf(((ItemStack)list.get(i)).method_7947()),
               (double)(((float)(this.xOffset.getValueInt() + this.xPlus.getValueInt() * i) + this.TextxPlus.getValueFloat()) / this.scale.getValueFloat()),
               ((double)this.yOffset.getValueInt() + 12.5 + this.yPlus.getValue()) / (double)this.scale.getValueFloat(),
