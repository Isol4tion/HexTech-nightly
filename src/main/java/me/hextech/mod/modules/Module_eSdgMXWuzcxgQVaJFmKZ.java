package me.hextech.mod.modules;
...
public abstract class Module_eSdgMXWuzcxgQVaJFmKZ
    ...
    public Module_eSdgMXWuzcxgQVaJFmKZ(String name, Category category) {
        this(name, "", category);
    }

    public Module_eSdgMXWuzcxgQVaJFmKZ(String name, String description, Category category) {
        super(name);
    ...
    public static void sendNotify(String string) {
        Notify_EXlgYplaRzfgofOPOkyB.notifyList.add(new Notify_EXlgYplaRzfgofOPOkyB.NotifyInfo(string));
    }
    ...
    public void enable() {
        ...
        if (!Module_eSdgMXWuzcxgQVaJFmKZ.nullCheck() && this.drawnSetting.getValue()) {
            ...
            if (Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.isOn() && Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.type.getValue() == Notify_EXlgYplaRzfgofOPOkyB.NotifyInfo.Mode.Both) {
                ...
                Module_eSdgMXWuzcxgQVaJFmKZ.sendNotify("\u00a7f[\u00a7b" + this.getName() + "\u00a7f]\u00a77 toggled \u00a7aon");
            } else if (Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.type.getValue() == Notify_EXlgYplaRzfgofOPOkyB.NotifyInfo.Mode.Chat) {
                switch (ChatSetting_qVnAbgCzNciNTevKRovy.INSTANCE.messageStyle.getValue()) {
                    case HexTech: {
                        CommandManager.sendChatMessageWidthId("\u00a7f" + this.getName() + " \u00a7a\u221a", id);
                        break;
    ...
    public void disable() {
        ...
        if (!Module_eSdgMXWuzcxgQVaJFmKZ.nullCheck() && this.drawnSetting.getValue()) {
            ...
            if (Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.isOn() && Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.type.getValue() == Notify_EXlgYplaRzfgofOPOkyB.NotifyInfo.Mode.Both) {
                ...
                Module_eSdgMXWuzcxgQVaJFmKZ.sendNotify("\u00a7f[\u00a7b" + this.getName() + "\u00a7f]\u00a77 toggled \u00a74off");
            } else if (Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.isOn() && Notify_EXlgYplaRzfgofOPOkyB.INSTANCE.type.getValue() == Notify_EXlgYplaRzfgofOPOkyB.NotifyInfo.Mode.Chat) {
                switch (ChatSetting_qVnAbgCzNciNTevKRovy.INSTANCE.messageStyle.getValue()) {
                    case HexTech: {
                        CommandManager.sendChatMessageWidthId("\u00a7f" + this.getName() + " \u00a7cX", id);
                        break;
