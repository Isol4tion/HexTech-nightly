...
extends Module_eSdgMXWuzcxgQVaJFmKZ {
    ...
    EnumSetting mode = this.add(new EnumSetting<Mode>("Mode", Mode.Normal));
    SliderSetting pointsNew = this.add(new SliderSetting("Points", 3, 1, 10, v -> this.mode.getValue() == Mode.Normal));
    SliderSetting interval = this.add(new SliderSetting("Interval ", 2, 1, 100, v -> this.mode.getValue() == Mode.New));
     ...
     * Exception performing whole class analysis ignored.
     */
    record CrystalPlaceESP(EndCrystalEntity entity, long time) {
    }
}
