                ...
                for (final double y3 : array10) {
                    for (final double offset3 : xzOffset) {
                        ...
                        if (this.isObsidian(offsetPos4)) {
                            for (final MineManager_aMxFbgVZCMGgbqNPBFpw.MineInfo breakData : new HashMap<>(HexTech.BREAK.breakMap).values()) {
                                if (breakData != null) {
                    ...
                    for (final double offset3 : xzOffset) {
                        for (final double offset4 : xzOffset) {
                            ...
                            if (this.isObsidian(offsetPos5)) {
                                for (final MineManager_aMxFbgVZCMGgbqNPBFpw.MineInfo breakData2 : new HashMap<>(HexTech.BREAK.breakMap).values()) {
                                    if (breakData2 != null) {
