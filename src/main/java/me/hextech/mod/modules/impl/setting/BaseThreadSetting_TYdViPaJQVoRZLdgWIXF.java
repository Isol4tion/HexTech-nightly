...
import me.hextech.api.utils.combat.ListenerDamage;
import me.hextech.api.utils.combat.ListenerHelper;
import me.hextech.api.utils.combat.ListenerHelperUtil;
...
import me.hextech.mod.modules.impl.combat.Cleaner_iFwqnooxsJEmHoVteFeQ;
import me.hextech.mod.modules.impl.combat.WebAuraTick;
import me.hextech.mod.modules.impl.player.Blink;
import me.hextech.mod.modules.impl.player.NoRotateSet;
...
public class BaseThreadSetting_TYdViPaJQVoRZLdgWIXF
    ...
    public final EnumSetting<Page> page = this.add(new EnumSetting<Page>("Page", Page.Thread));
    public final BooleanSetting multiThread = this.add(new BooleanSetting("MultiThread", true, v -> this.page.is(Page.Thread)));
    public final BooleanSetting crystalThread = this.add(new BooleanSetting("CrystalThread", true, v -> this.page.is(Page.Thread)));
    public final BooleanSetting rotatepacket = this.add(new BooleanSetting("PacketRotate", false, v -> this.page.is(Page.Thread)));
    public final BooleanSetting jumpCooldown = this.add(new BooleanSetting("JumpCooldown", true, v -> this.page.is(Page.Change)));
    public final BooleanSetting antiopen = this.add(new BooleanSetting("AntiOpen", true, v -> this.page.is(Page.Change)));
    public final BooleanSetting packethook = this.add(new BooleanSetting("MixinPacketHook", true, v -> this.page.is(Page.Mixin)));
    public final BooleanSetting movehook = this.add(new BooleanSetting("MixinMoveHook", true, v -> this.page.is(Page.Mixin)));
    public final SliderSetting minrad = this.add(new SliderSetting("OffTrackRadian", 0, 0, 30, v -> this.page.is(Page.Dev)).setSuffix("/-Age"));
    public final BooleanSetting attack = this.add(new BooleanSetting("Attack\u00a74(DeSync)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Aweb = this.add(new BooleanSetting("Attack\u00a74(AutoWeb)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Async = this.add(new BooleanSetting("Attack\u00a74(AutoCrystal.INSTANCE)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Arenderslinder = this.add(new BooleanSetting("Attack\u00a74(AutoCrystal)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Arotate = this.add(new BooleanSetting("Attack\u00a74(Rotate)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting defend = this.add(new BooleanSetting("Defend\u00a7b(AutoCrystal.INSTANCE)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Dweb = this.add(new BooleanSetting("Defend\u00a7b(AutoWeb)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Dsync = this.add(new BooleanSetting("Defend\u00a7b(AutoCrystal.INSTANCE)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Drenderslinder = this.add(new BooleanSetting("Defend\u00a7b(AutoCrystal)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting Drotate = this.add(new BooleanSetting("Defend\u00a7b(Rotate)", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting smart = this.add(new BooleanSetting("Smart-Out1", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting smart2 = this.add(new BooleanSetting("Smart-Out2", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting smart3 = this.add(new BooleanSetting("Smart-Out3", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting inmoveSync = this.add(new BooleanSetting("MovingSync", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting staticSync = this.add(new BooleanSetting("StaticSync", false, v -> this.page.is(Page.ComboBreaks)));
    public final BooleanSetting burrowcleaner = this.add(new BooleanSetting("StartBurrowCleaner", false, v -> this.page.is(Page.ComboBreaks)));
    public final SliderSetting blockposx = this.add(new SliderSetting("BlockPosX", 0.3, 0.0, 1.0, v -> this.page.is(Page.Fix)));
    public final BooleanSetting nullfix = this.add(new BooleanSetting("AntiWorldNull", true, v -> this.page.is(Page.Fix)));
    public final SliderSetting fadeInQuad = this.add(new SliderSetting("FadeInQuad", 1, -1, 1, v -> this.page.is(Page.FadeUtils)));
    public final SliderSetting fadeInEnd = this.add(new SliderSetting("FadeEnd", 1, -1, 1, v -> this.page.is(Page.FadeUtils)));
    public final SliderSetting fadeInlength = this.add(new SliderSetting("FadeInLength", 3, -3, 3, v -> this.page.is(Page.FadeUtils)));
    ...
    public BaseThreadSetting_TYdViPaJQVoRZLdgWIXF() {
        super("BaseThreadSetting", Category.Setting);
        INSTANCE = this;
    }
    ...
    private void update() {
        ...
        if (!list.isEmpty()) {
            for (BlockPos pos : BlockUtil.getSphere((float) AutoCrystal_QcRVYRsOqpKivetoXSJa.INSTANCE.range.getValue() + 1.0f)) {
                ...
                if (BaseThreadSetting_TYdViPaJQVoRZLdgWIXF.mc.player.getEyePos().distanceTo(pos.toCenterPos().add(0.0, -0.5, 0.0)) > AutoCrystal_QcRVYRsOqpKivetoXSJa.INSTANCE.range.getValue() || !ListenerHelperUtil.canPlaceCrystal(pos, true, false))
                    continue;
                ...
                for (PredictionSetting._XBpBEveLWEKUGQPHCCIS pap : list) {
                    float selfDamage;
                    if (pos.down().getY() > pap.player.getBlockY() || AutoCrystal_QcRVYRsOqpKivetoXSJa.INSTANCE.lite.getValue() && ListenerHelperUtil.liteCheck(pos.toCenterPos().add(0.0, -0.5, 0.0), pap.predict.getPos()))
                        continue;
