...
public class InteractUtil
    ...
    public static HitResult getRtxTarget(float yaw, float pitch, double x, double y, double z) {
        ...
        Vec3d vec3d = new Vec3d(x, y, z).add(0.0, InteractUtil.mc.player.getEyeHeight(InteractUtil.mc.player.getPose()), 0.0);
    ...
    public static HitResult rayTrace(double dst, float yaw, float pitch, double x, double y, double z) {
        ...
        return InteractUtil.mc.world.raycast(new RaycastContext(vec3d, vec3d3, RaycastContext.ShapeType.OUTLINE, RaycastContext.FluidHandling.NONE, InteractUtil.mc.player));
    }
